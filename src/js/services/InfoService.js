...
class InfoService {
    ...
    refreshDisplayedInfo() {
        ...
        //$("#connectedUsersCount")[0].innerText("<div class='numberCircle'>300</div>")
        // console.log(String(nbConnectedUsers));
        // $("#connectedUsersCount")[0].innerHTML = "<div class='numberCircle'>"+String(nbConnectedUsers)+"</div>";
